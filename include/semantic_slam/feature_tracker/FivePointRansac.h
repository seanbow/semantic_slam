...
#include <iostream>
#include <opencv/cv.h>
/* @brief RANSAC class. It is is initialized and preallocates all the space needed for it to run. 
 * The space is pre-allocated since the ransac runs in an iterative scheme and destroy.
...
public:
	...
	/*
	 * @brief selects a random set up to @param number_of_points_ for the hypothesis
	...
	struct Hypothesis
	{   
		Eigen::Matrix<double,3,30>  solutions; // essential matrices, 3x(3*totalSolutions)
		int totalSolutions; 
