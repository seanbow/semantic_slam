...
public:
    ...
    TriangulationResult triangulateMeasurementsApproximate(const aligned_vector<Eigen::Vector2d>& pixel_msmts,
                                            int n_cameras = 50,
                                            boost::optional<double&> condition_number = boost::none);

    TriangulationResult triangulateIterative(const aligned_vector<Eigen::Vector2d>& pixel_msmts);
