...
bool DoublePriorCostTerm::Evaluate(double const* const* parameters, double* residual, double** jacobians) const
{
...
ceres::CostFunction* DoublePriorCostTerm::Create(double prior, double prior_covariance)
{
